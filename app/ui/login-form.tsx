...
import { ArrowRight, AtSign, KeySquare } from 'lucide-react';
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              <input
                ...
                minLength={6}
              />
              <KeySquare className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
          </div>
        </div>
